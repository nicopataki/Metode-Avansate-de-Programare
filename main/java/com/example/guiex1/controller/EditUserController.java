...
public class EditUserController {
    ...
    public void handleSave(){
        ...
        Utilizator utilizator1=new Utilizator(firstNameText,lastNameText, username, password);
    ...
    private void updateMessage(Utilizator m)
    {
        try {
            ...
            if (r==null)
                MessageAlert.showMessage(null, Alert.AlertType.INFORMATION,"Modify user","User succesfully updated!");
    ...
    private void saveMessage(Utilizator m)
    {
        ...
        try {
            ...
            if (r==null)
                dialogStage.close();
            MessageAlert.showMessage(null, Alert.AlertType.INFORMATION,"Save user","Mesajul a fost salvat");
        } catch (ValidationException e) {
            MessageAlert.showErrorMessage(null,e.getMessage());
        }
        dialogStage.close();
